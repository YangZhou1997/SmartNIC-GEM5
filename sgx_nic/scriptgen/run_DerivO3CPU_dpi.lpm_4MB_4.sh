...
build/ARM/gem5.fast \
    ...
    --stats-file=DerivO3CPU_dpi.lpm_4MB_4_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_DerivO3CPU_dpi.lpm_4MB_4.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_DerivO3CPU_dpi.lpm_4MB_4.out
