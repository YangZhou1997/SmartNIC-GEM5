...
build/ARM/gem5.fast \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_DerivO3CPU_nat-tcp-v4_2MB.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_DerivO3CPU_nat-tcp-v4_2MB.out
