...
build/ARM/gem5.fast \
    ...
    --stats-file=TimingSimpleCPU_acl-fw.dpi.maglev.lpm.monitoring_4MB_44_stats.txt \
    configs/example/se_nic.py \
    --interp-dir /usr/aarch64-linux-gnu \
    --redirects /lib=/usr/aarch64-linux-gnu/lib \
    -c "acl-fw;dpi;maglev;lpm;monitoring" \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_TimingSimpleCPU_acl-fw.dpi.maglev.lpm.monitoring_4MB_44.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_TimingSimpleCPU_acl-fw.dpi.maglev.lpm.monitoring_4MB_44.out
