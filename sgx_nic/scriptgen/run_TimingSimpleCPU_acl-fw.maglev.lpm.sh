...
build/ARM/gem5.fast \
    ...
    --stats-file=TimingSimpleCPU_acl-fw;maglev;lpm_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_TimingSimpleCPU_acl-fw;maglev;lpm.out    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_TimingSimpleCPU_acl-fw;maglev;lpm.out
