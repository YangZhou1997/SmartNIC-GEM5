...
build/ARM/gem5.fast \
    ...
    --stats-file=TimingSimpleCPU_acl-fw.nat-tcp-v4.maglev_4MB_4_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_TimingSimpleCPU_acl-fw.nat-tcp-v4.maglev_4MB_4.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_TimingSimpleCPU_acl-fw.nat-tcp-v4.maglev_4MB_4.out
