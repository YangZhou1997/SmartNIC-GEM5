...
build/ARM/gem5.fast \
    ...
    --stats-file=TimingSimpleCPU_dpi;maglev;lpm;monitoring_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_TimingSimpleCPU_dpi;maglev;lpm;monitoring.out    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_TimingSimpleCPU_dpi;maglev;lpm;monitoring.out
