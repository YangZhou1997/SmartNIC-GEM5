...
build/ARM/gem5.fast \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_TimingSimpleCPU_dpi.nat-tcp-v4.maglev_4MB_44.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_TimingSimpleCPU_dpi.nat-tcp-v4.maglev_4MB_44.out
