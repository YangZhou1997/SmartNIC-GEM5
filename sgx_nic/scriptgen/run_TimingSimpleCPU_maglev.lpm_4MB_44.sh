...
build/ARM/gem5.fast \
    ...
    --stats-file=TimingSimpleCPU_maglev.lpm_4MB_44_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_TimingSimpleCPU_maglev.lpm_4MB_44.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_TimingSimpleCPU_maglev.lpm_4MB_44.out
