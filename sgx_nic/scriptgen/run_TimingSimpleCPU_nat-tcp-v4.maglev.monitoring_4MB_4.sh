...
build/ARM/gem5.fast \
    ...
    --stats-file=TimingSimpleCPU_nat-tcp-v4.maglev.monitoring_4MB_4_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/nic/stdout_TimingSimpleCPU_nat-tcp-v4.maglev.monitoring_4MB_4.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/nic/stderr_TimingSimpleCPU_nat-tcp-v4.maglev.monitoring_4MB_4.out
