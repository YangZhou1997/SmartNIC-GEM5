...
#         SimpleMemory
#         LPDDR2_S4_1066_1x32
memctrls = ['DDR3_1600_8x8', 'DDR4_2400_8x8']
    ...
    for cpu in cpus:
        for mem in memctrls:
            for nf in singleprog:
                cmd = nf
                for l2 in l2_size:
                    filename = f'{cpu}_{mem}_{cmd}_{l2}'                    
                    ...
                    command += "    --mem-size=256GB --mem-type=" + mem + " --mem-channels=2 --mem-ranks=2 \\\n"
