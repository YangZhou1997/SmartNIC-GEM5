...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=m5out/nic \
    --stats-file=HPI_DDR3_1600_8x8_dpi;nat-tcp-v4;lpm;monitoring_stats.txt \
    ...
    > /users/yangzhou/gem5/sim_nic/results/nic/stdout_HPI_DDR3_1600_8x8_dpi;nat-tcp-v4;lpm;monitoring.out
